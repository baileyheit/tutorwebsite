...
def upcoming_sessions():
        ...
        return render_template('session_tables.html', title='Upcoming Sessions', sessions = sessions)
...
def past_sessions():
    user_id = current_user.id
    sessions = Session.query.filter_by((tutor == user_id or tutee == user_id) and datetime(date, time) < datetime(date.today(), datetime.min.time()))
    return render_template('session_tables.html', title='Past Sessions', sessions = sessions)
