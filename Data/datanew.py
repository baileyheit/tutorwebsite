...
for i in range(500):
    ...
    if tutee_uid is not None:
        ...
        booked = False
    sid = uuid.uuid4().int & (1<<32)-1

    sessions[sid] = {
        'session_id': sid,
        'zoom_link': user.numerify(text='https://us02web.zoom.us/j/###########?'),
        'day': str(user.future_date(end_date='+30d', tzinfo=None)),
        'time': user.time(),
...
print("TUTORS STARTS HERE")
for x in tutors:
    print(tutors[x])
print("TUTORS ENDS HERE")

print("TUTTEES STARTS HERE")
for x in tutees:
    print(tutees[x])
print("TUTTEES ENDS HERE")
...
print("CANTUTORIN STARTS HERE")
for x in can_tutor_in:
    print(can_tutor_in[x])
print("CANTUTORIN ENDS HERE")

print("NEEDSHELPWITH STARTS HERE")
for x in needs_help_with:
    print(needs_help_with[x])
print("NEEDSHELPWITH ENDS HERE")

print("TUTORSIN STARTS HERE")
for x in tutors_in:
    print(tutors_in[x])
print("TUTORSIN ENDS HERE")

print("GETSHELPIN STARTS HERE")
for x in gets_help_in:
    print(gets_help_in[x])
print("GETSHELPIN ENDS HERE")


print("FORHELPIN STARTS HERE")
for x in for_help_in:
    print(for_help_in[x])
print("FORHELPIN ENDS HERE")

print("GIVESRATING STARTS HERE")
for x in gives_rating:
    print(gives_rating[x])
print("GIVESRATING ENDS HERE")
