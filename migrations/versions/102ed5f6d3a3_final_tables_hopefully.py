"""final tables (hopefully)

Revision ID: 102ed5f6d3a3
Revises: 
Create Date: 2020-11-12 22:37:10.112374
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['session'], ['session.session_id'], ),
    sa.ForeignKeyConstraint(['tutee'], ['user.id'], ),
    sa.ForeignKeyConstraint(['tutor'], ['user.id'], ),
